...
Codex Codex-sonnet-4-6 and GPT-4o can read handwriting directly from images with
...
[Pre-processor]          ← Deskew, enhance contrast, crop to data area
    ...
    ▼
[Vision LLM Extractor]   ← Codex Codex-sonnet-4-6 with decade-specific prompt
